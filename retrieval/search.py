...
class Search:
    ...
    def find(self, question: str,
             doc_ids: list[str] | None = None) -> SearchOutcome:
        """doc_ids=None searches the whole corpus; a list scopes retrieval
        to just those documents (e.g. a user-selected subset in the UI)."""
        ...
        kept = [r for r in ranked if r.score >= self.score_floor]
